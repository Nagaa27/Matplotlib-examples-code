...
if 1 :
	...
	#kecondongan gambar
	im2 = ax2.imshow(Z, interpolation='none', cmap=cm.jet, origin='lower',
					extent=[-2, 4, -3, 2], clip_on=True)
	im2._image_skew_coordinate  = (3, -2)
	
	plt.show()
	#menyimpan dalam ("demo_affine_image")
